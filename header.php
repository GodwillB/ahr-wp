...
@font-face {
  ...
  src: url("<?php echo get_template_directory_uri(); ?>/css/fonts/G_ari_bd.TTF");
	...
	<div class="ahr-parent-sticky">
		<p class="button-58 menu-toggle ahr-menu-absolute" >Menu <svg style="margin-left: 12px;" width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg">
